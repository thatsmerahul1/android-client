 ...
 */
public class GroupChatImpl extends QBMessageListenerImpl<QBGroupChat> implements IChat {
    ...
    public GroupChatImpl(Activity activity) {
        mActivity = activity;
    }
    ...
    private void join(final QBGroupChat groupChat, final QBEntityCallback callback) {
        ...
        groupChat.join(history, new QBEntityCallbackImpl() {
            ...
            public void onError(final List list) {
                ...
                Log.w("Could not join,errors:", Arrays.toString(list.toArray()));
            }
        });
    }
